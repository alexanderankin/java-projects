...
class OpenTelemetryAppenderTest {
    ...
    void setUp() {
        ...
        appender = new OpenTelemetryAppender(new GetFormattedMessageEncoder(), openTelemetry);
    }
    ...
    private static class GetFormattedMessageEncoder extends EncoderBase<ILoggingEvent> {
        @Override
